...
#define CONFIGURE_COMMAND " './php/configure'  '--enable-embed=static' '--enable-zts' '--disable-zend-signals' '--disable-opcache-jit' '--enable-static' '--enable-shared=no' '--with-iconv=/opt/homebrew/opt/libiconv/' '--with-openssl=/opt/homebrew/opt/openssl/'"
...
#define PHP_EXTENSION_DIR       "/usr/local/lib/php/extensions/no-debug-zts-20220829"
